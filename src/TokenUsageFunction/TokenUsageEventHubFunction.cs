...
{
    public class TokenUsageEventHubFunction
    {
        ...
        public TokenUsageEventHubFunction(TokenServiceFactory tokenServiceFactory, TelemetryClient telemetryClient, ILoggerFactory loggerFactory)
        {
            _tokenServiceFactory = tokenServiceFactory;
            _telemetryClient = telemetryClient;
            _logger = loggerFactory.CreateLogger<TokenUsageEventHubFunction>();
